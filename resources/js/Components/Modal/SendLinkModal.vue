    ...
    <div class="container">
      <div class="content">
        ...
        <div class="pt-[30px]">
          ...
          <input type="url" class="border-x-0 border-t-0 w-[90%]">
          <div class="mt-3">
            <input type="checkbox" name="" id="checkbox">
            <label for="checkbox" class="ml-3 text-gray-700">縮短網址</label>
          </div>
          <div class="flex justify-end">
            <button type="button" class="btn px-5 py-2 text-gray-700 hover:bg-grey-light rounded-[10px] mr-3" @click="closing()">取消</button>
            <button type="button" class="btn px-5 py-2 border border-grey rounded-[10px] text-gray-700 hover:bg-grey-light">複製</button>
          </div>
        </div>
      </div>
    </div>
