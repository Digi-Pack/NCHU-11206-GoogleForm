  ...
  data() {
    return {
      arrayA: [
        ...
        { 'id': 3, 'title': '單選方格第二題', 'request': false, 'image': null, 'video': null, 'type': 8, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': '第一列' }, { 'id': 2, 'text': '第二列' }, { 'id': 3, 'text': '第三列' }], 'column': [{ 'id': 1, 'text': '第一欄' }, { 'id': 2, 'text': '第二欄' }, { 'id': 3, 'text': '第三欄' }, { 'id': 4, 'text': '第四欄' }, { 'id': 5, 'text': '第五欄' }] } },
        ...
        { 'id': 5, 'title': '我是時間第二題', 'request': false, 'image': null, 'video': null, 'type': 11, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': null }], 'column': [{ 'id': 1, 'text': null }] } },

        { 'id': 6, 'title': '我是線性刻度第一題    範圍1-7', 'request': false, 'image': null, 'video': null, 'type': 7, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': '1', 'max': '7', 'minText': '不快樂', 'maxText': '快樂' }, 'square': { 'row': [{ 'id': 1, 'text': null }], 'column': [{ 'id': 1, 'text': null }] } },

        { 'id': 7, 'title': '我是核取方塊格第一題', 'request': false, 'image': null, 'video': null, 'type': 9, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': '第一列' }], 'column': [{ 'id': 1, 'text': '第一欄' }, { 'id': 2, 'text': '第二欄' }, { 'id': 3, 'text': '第三欄' }, { 'id': 4, 'text': '第四欄' }] } },

        { 'id': 8, 'title': '我是下拉式選單第二題', 'request': false, 'image': null, 'video': null, 'type': 5, 'options': [{ 'id': 1, 'value': '下拉選項一' }, { 'id': 2, 'value': '下拉選項二' }, { 'id': 3, 'value': '下拉選項三' }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': null }], 'column': [{ 'id': 1, 'text': null }] } },

        { 'id': 9, 'title': '我是核取方塊格第二題', 'request': false, 'image': null, 'video': null, 'type': 9, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': '第一列' }, { 'id': 2, 'text': '第二列' }, { 'id': 3, 'text': '第三列' }, { 'id': 4, 'text': '第四列' }], 'column': [{ 'id': 1, 'text': '第一欄' }, { 'id': 2, 'text': '第二欄' }, { 'id': 3, 'text': '第三欄' }, { 'id': 4, 'text': '第四欄' }] } },

        { 'id': 10, 'title': '單選方格第一題', 'request': false, 'image': null, 'video': null, 'type': 8, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': '第一題第一列' }, { 'id': 2, 'text': '第一題第二列' }, { 'id': 3, 'text': '第一題第三列' }, { 'id': 4, 'text': '第一題第四列' }], 'column': [{ 'id': 1, 'text': '第一欄' }, { 'id': 2, 'text': '第二欄' }] } },
        { 'id': 11, 'title': '這是日期第一題', 'request': false, 'image': null, 'video': null, 'type': 10, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': 1, 'max': 10, 'minText': null, 'maxText': null }, 'square': { 'row': [{ 'id': 1, 'text': null }], 'column': [{ 'id': 1, 'text': null }] } },
        { 'id': 12,
        ...
        { 'id': 13, 'title': '我是線性刻度第二題    範圍0-6', 'request': false, 'image': null, 'video': null, 'type': 7, 'options': [{ 'id': 1, 'value': null }], 'linear': { 'min': '0', 'max': '6', 'minText': '不快樂', 'maxText': '快樂' }, 'square': { 'row': [{ 'id': 1, 'text': null }], 'column': [{ 'id': 1, 'text': null }] } },
      ...
      arrayB: [
        [
          ...
          { 'id': 3, 'answer': null, 'manyOptions': ['row1col5', 'row2col5', 'row3col1'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 4, 'answer': null, 'manyOptions': [1, 3], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 5, 'answer': null, 'manyOptions': [], 'time': { 'hour': '03', 'minute': '03', 'section': 'p.m.' } },
          { 'id': 6, 'answer': null, 'manyOptions': 7, 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 7, 'answer': null, 'manyOptions': ['row1col2', 'row1col3'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 8, 'answer': 2, 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 9, 'answer': null, 'manyOptions': ['row1col1', 'row2col1', 'row3col2', 'row4col3', 'row1col4', 'row2col4', 'row3col4'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 10, 'answer': null, 'manyOptions': ['row1col2', 'row2col2', 'row3col1', 'row4col1'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 11, 'answer': '2023-07-01', 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 12, 'answer': null, 'manyOptions': [1, 3, 2], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 13, 'answer': null, 'manyOptions': 5, 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          ...
          { 'id': 16, 'answer': 1, 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
        ],
        [{ 'id': 1, 'answer': 2, 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          ...
          { 'id': 5, 'answer': null, 'manyOptions': [], 'time': { 'hour': '03', 'minute': '03', 'section': 'p.m.' } },
          { 'id': 6, 'answer': null, 'manyOptions': 7, 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 7, 'answer': null, 'manyOptions': ['row1col4', 'row1col3'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 8, 'answer': 2, 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 9, 'answer': null, 'manyOptions': ['row1col2', 'row2col3', 'row3col3', 'row4col3', 'row1col4', 'row2col4', 'row3col4'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 10, 'answer': null, 'manyOptions': ['row1col2', 'row2col2', 'row3col1', 'row4col1'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 11, 'answer': '2023-07-15', 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 12, 'answer': null, 'manyOptions': [1, 3, 2], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 13, 'answer': null, 'manyOptions': 1, 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
        ...
        [
          ...
          { 'id': 3, 'answer': null, 'manyOptions': ['row1col5', 'row2col5', 'row3col1'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 4, 'answer': null, 'manyOptions': [1, 3], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 5, 'answer': null, 'manyOptions': [], 'time': { 'hour': '01', 'minute': '03', 'section': 'p.m.' } },
          { 'id': 6, 'answer': null, 'manyOptions': 3, 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 7, 'answer': null, 'manyOptions': ['row1col4', 'row1col3'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 8, 'answer': 3, 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 9, 'answer': null, 'manyOptions': ['row1col3', 'row2col3', 'row3col3', 'row4col3', 'row1col4', 'row2col4', 'row3col4'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 10, 'answer': null, 'manyOptions': ['row1col2', 'row2col2', 'row3col1', 'row4col1'], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 11, 'answer': '2023-07-01', 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 12, 'answer': null, 'manyOptions': [1, 3, 2], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          { 'id': 13, 'answer': null, 'manyOptions': 5, 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
          ...
          { 'id': 16, 'answer': 2, 'manyOptions': [], 'time': { 'hour': null, 'minute': null, 'section': 'a.m.' } },
      ...
      return {
        ...
        data: question.options.map((option) => {
          ...
          this.arrayB.forEach((answerSet) => {
            ...
            if (answer && answer.answer === option.id) {
