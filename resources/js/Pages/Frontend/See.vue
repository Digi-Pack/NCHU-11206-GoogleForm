...
export default {
  data() {
    return {
      ...
      formData: [{
        ...
        video: '',
        type: 3,
        options: [{ id: '1', value: '123' }, { id: 2, value: '456' }],
  ...
  methods: {
    ...
    addclick() {
      const { formData, resPonse, Dataall } = this;
      router.visit(route('see.store'), { method: 'post', data: { formData, resPonse, Dataall } });
    },
...
<template>
  <section id="question">
    <button type="button" @click="addclick()">新增</button>
    <div class="container">
      <!-- 側欄 -->
      <div class="side">
